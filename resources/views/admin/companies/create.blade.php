...
<div class="row">
    <div class="col-xl-12">
        <div class="card-box">
            ...
            <form action="/{{ app()->getLocale() }}/admin/companies" method="POST" data-parsley-validate novalidate>
                @csrf
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade @if($locale == app()->getLocale()) active show @endif" id="locale-{{ $locale }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error($locale.'.country') is-invalid @enderror" id="{{ $locale }}-country" name="{{ $locale }}[country]" value="{{ old($locale.'.country') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor @error($locale.'.description') is-invalid @enderror" id="{{ $locale }}-description" name="{{ $locale }}[description]" rows="3">{{ old($locale.'.description') }}</textarea>
                ...
                <div class="form-group text-right mb-0">
                    <button type="submit" class="btn btn-primary waves-effect waves-light mr-1" id="save-button">Create Company</button>
